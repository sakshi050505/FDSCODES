...
PROBLEM STATEMENT:
WRITE C++ PROGRAM USING PRIM'S AND KRUSKAL'S ALGORITHM TO DEVELOP
AN OPTIMIZED MEDICAL EQUIPMENT ALLOCATION PLAN THAT ENSURE EFFICIENY 
AND EFFECTIVE HEALTH CARE DELIVERY WHILE MINIMIZING COST AND
