...
PROBLEM STATEMENT:
WRITE C++ PROGRAM USING PRIM'S AND KRUSKAL'S ALGORITHM TO DEVELOP AN OPTIMIZED MEDICAL EQUIPMENT ALLOCATION PLAN
THAT ENSURE EFFICIENY AND EFFECTIVE HEALTH CARE DELIVERY WHILE MINIMIZING COST AND MAXIMUM PATIENT OUTCOMES.

OBJECTIVE:
1. To understand prim's and kruskal's algorithm .
2. To create medical equipment allocation program .
*/
